...
#ifndef DALI_OPERATORS_GENERIC_REDUCE_ROOT_MEAN_SQUARE_H__
#define DALI_OPERATORS_GENERIC_REDUCE_ROOT_MEAN_SQUARE_H__
...
/// for RootMeanSquare operator. Is uesed as parameter to TYPE_MAP macro.
#define ROOT_MEAN_SQUARE_TYPES_MAP ( \
...
class RootMeanSquareOp : public Reduce<ReductionType, Backend, RootMeanSquareOp> {
 public:
  explicit inline RootMeanSquareOp(const OpSpec &spec) :
    Reduce<ReductionType, Backend, RootMeanSquareOp>(spec) {}
...
#endif  // DALI_OPERATORS_GENERIC_REDUCE_ROOT_MEAN_SQUARE_H_
